...
app.config(['$translateProvider', function ($translateProvider) {
  $translateProvider.translations('en', {
	...
	'FEATURE_CHANGE_POINT_OF_VIEW_T_P1': 'Drimz is an ecosystem which is comprises the iOS AR painter tool and our in-house blockchain engine. This ecosystem is social and people-oriented: all the art you create with the application will be transparently available to others. They can evaluate it by voting. If the community likes your art, it will become public. If it does not - do not worry, we remove expositions after a certain time just like in Snapchat, thus you may be luckier the next time!',
	...
	'FEATURE_ENCHANCE_BY_COLLABORATION_T_P1': 'When working on your expo, free to join other people who share your idea, and help each other create the image that is on your mind. Additionally, if you like an idea of a different author, it is not necessary to do something similar from skratch. Instead, just modify their art and check what other people think about it.',
	...
	'FEATURE_NOGEO_EXPOS_T_P1': 'Some paintings definitely require geographical context and are best viewed only in certain places of our world. But. The majority of AR paintings people create do not need this bind, and we feel unfair to hide this gold from other people. Thus, if you decide so, your expo will be available ONLY in a certain position and direction. Otherwise, it will fall into the can-see-it-everywhere category, and other AR fans will be able to view it in their location or even on their wall!',	
