...
app.config(['$translateProvider', function ($translateProvider) {
  ...
  $translateProvider.translations('ru', {
	...
	'FEATURE_PERSONAL_EXPOS_T_P1': 'Не всегда вы хотите прокричать о своем творении сразу на весь мир. Иногда вы хотите поделиться только с кем-то особенным: с вашими лучшими друзьями, вашей девушкой или с мамой - и ни с кем больше. Это может быть частью подарка на годовщину или частью интригующего квеста: во всех подобных случаях мы с радостью придем к вам на помощь и ограничим количество людей, которые увидят ваш секретный подарок. Мы работаем над этим функционалом, и скоро он появится в приложении!',
	'FEATURE_NOGEO_EXPOS': 'Сотри границы и расстояния',
	'FEATURE_NOGEO_EXPOS_T_P1': 'Некоторым экспо точно нужен гео-контекст, и они смотрятся лучше всего в определенном месте. Но! Большинство AR образов, которые создают члены сообщества, не привязаны ни к чему конкретному, и мы считаем нечестным прятать их от других людей. Поэтому, если вы так решите, ваше экспо будет доступным ТОЛЬКО в определенном месте и направлении. Иначе, мы будем считать, что его можно просматривать везде: другие AR гики смогут просмотреть его в своем дворе или даже у себя в квартире!',	
