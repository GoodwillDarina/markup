...
app.config(['$translateProvider', function ($translateProvider) {
  $translateProvider.translations('en', {
	...
	'FEATURE_CHANGE_POINT_OF_VIEW_T_P1': 'Drimz is an ecosystem which is comprises the iOS augmented reality painting tool and our in-house blockchain engine. This ecosystem is social and people-oriented: all the art you create with the application will be transparently available to others. They can evaluate it by voting. If the community likes your art, it will become public. If it does not - do not worry, we remove drawings after a certain time just like in Snapchat, thus you may be luckier the next time!',
	'FEATURE_CHANGE_POINT_OF_VIEW_T_P2': 'We invite you to get inspired by amazing AR (augmented reality) art created by our community, create your own virtual drawings, and share them with your friends! Reveal the best of you by expressing yourself and enjoy our AR editor features for free!',	
	'FEATURE_ENCHANCE_BY_COLLABORATION': 'Enhance by collaboration',
	'FEATURE_ENCHANCE_BY_COLLABORATION_T_P1': 'When working on your drawing, free to join other people who share your idea, and help each other create the image that is on your mind. Additionally, if you like an idea of a different author, it is not necessary to do something similar from skratch. Instead, just modify their art and check what other people think about it.',
	...
	'FEATURE_NOGEO_EXPOS_T_P1': 'Some paintings definitely require geographical context and are best viewed only in certain places of our world. But. The majority of augmented reality paintings people create do not need this bind, and we feel unfair to hide this gold from other people. Thus, if you decide so, your painting will be available ONLY in a certain position and direction. Otherwise, it will fall into the can-see-it-everywhere category, and other AR fans will be able to view it in their location or even on their wall!',	
  ...
  $translateProvider.translations('ru', {
	...
	'FEATURE_CHANGE_POINT_OF_VIEW_T_P1': 'Дримз - это экосистема, в которую входит редактор AR (дополненной реальности) и наш собственный блокчейн. Мы сделали ее социально-ориентированной: все экспо (AR-образы), которые вы создаете, становятся доступными остальным членам сообщества. Они могут оценить ваше творение путем голосования. Если ваше экспо нравится сообществу, оно остается публично-доступным. Если не нравится - не переживайте, мы удаляем все экспозиции через определенное время, прямо как Snapchat. Вы можете попытать счастье еще раз, ведь весь этот мир эфемерен и недолговечен!',
	'FEATURE_CHANGE_POINT_OF_VIEW_T_P2': 'Мы приглашаем вас насладиться удивительными AR образами, созданными нашим сообществом, создавать свои произведения и делиться ими с друзьями! Откройте в себе новые грани креативности и с удовольствем пользуйтесь нашим AR редактором совершенно бесплатно!',	
	'FEATURE_ENCHANCE_BY_COLLABORATION': 'Улучшай через взаимодействие',
	'FEATURE_ENCHANCE_BY_COLLABORATION_T_P1': 'Когда вы работаете над экспо, не стесняйтесь объединяться с другими людьми, которые разделяют ваши идеи, и помогайте друг-другу реализовать задуманное. Если вам нравится чья-то другая идея, не обязательно копировать ее или повторять с нуля. Вместо этого вы можете доработать образ другого художника и узнать, что об этом думает сообщество.',
	'FEATURE_ENCHANCE_BY_COLLABORATION_T_P2': 'Объединяйтесь в команды, реализуя свои идеи, ведь это помогает высвободить ваш совместный креативный потенциал и создать заряд синергии. В Дримз, мы стараемся обеспечить вас всеми инструментами, чтобы сделать этот процесс простым, веселым и приятным, с легкостью позволяя командам художников создавать сложные и зрелищные образы!',
	'FEATURE_EARN_ON_MODERATION': 'Получай крипто валюту, помогая сообществу',
	'FEATURE_EARN_ON_MODERATION_T_P1': 'Мы хотим, чтобы Дримз был отличным местом, которое вы можете посетить с друзьями или с семьей. Мы надеемся, что вы разделяете наши ценности и расчитываем на вашу помощь в поддержании системы чистой от неподобающего, угрожающего и некачественного контента. Каждое ваше действие в этом направлении поощряется: мы даем крипто коины (DCN) каждый раз, когда вы оцениваете чью-то работу или рассказываете о нас кому-нибудь. Мы рады вашим усилиям, которые вы прилагаете, чтобы сделать наше сообщество больше и лучше!',
	'FEATURE_EARN_ON_MODERATION_T_P2': 'Наша экономика проста: Пользователи весело проводят время, наблюдая за экспо друг друга, в то время как Спонсоры (бизнес) платят $$$ чтобы создать большие и помпезные экспо и продвинуть себя или свои продукты. Средства, которые они платят, делятся между членами нашего сообщества, оставляя немного нашей команде, которая разрабатывает и поддерживает Дримз.',	
	'FEATURE_EARN_ON_MODERATION_T_P3': 'Существующий курс обмена DCN на USD и журнал транзакций доступны тут:',
	'FEATURE_EARN_ON_MODERATION_T_P4': '[ Журнал ]',	
	'FEATURE_PERSONAL_EXPOS': 'Удивляй только самых близких',
	'FEATURE_PERSONAL_EXPOS_T_P1': 'Не всегда вы хотите прокричать о своем творении сразу на весь мир. Иногда вы мечтаете поделиться только с кем-то особенным: с вашими лучшими друзьями, вашей девушкой или с мамой - и ни с кем больше. Это может быть частью подарка на годовщину или частью интригующего квеста: во всех подобных случаях мы с радостью ограничим количество людей, которые увидят ваш секретный подарок. Мы работаем над этим функционалом, и скоро он появится в приложении!',
	'FEATURE_NOGEO_EXPOS': 'Сотри границы и расстояния',
	'FEATURE_NOGEO_EXPOS_T_P1': 'Некоторым AR образам точно нужен гео-контекст, и они смотрятся лучше всего в определенном месте (например, усы на Эйфелевой башне). Но! Большинство AR образов, которые создают члены нашего сообщества, не привязаны ни к чему конкретному, и мы считаем нечестным прятать их от других людей. Поэтому, если вы так решите, ваше экспо будет доступным ТОЛЬКО в определенном месте и направлении. Иначе, мы будем считать, что его можно просматривать везде: другие любители AR смогут просмотреть его в своем дворе или даже у себя в квартире!',	
